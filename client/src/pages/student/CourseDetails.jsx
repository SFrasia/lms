...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLecturers, calculateCourseDuration,
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        <p className='text-sm font-semibold'>{calculateRating(courseData)}</p>
      ...
      <div className='py-20 text-sm md:text-default'>
        <h3 className='text-xl font-semibold text-gray-800'>Course Descriptiom</h3>
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
            ...
            <img src={assets.lesson_icon} alt="lesson icon" />
              <p>{calculateNoOfLecturers(courseData)} lessons</p>
            </div>
